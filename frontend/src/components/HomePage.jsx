    ...
    <div className="bg-gradient-to-r from-blue-100 via-purple-100 to-indigo-100 min-h-screen py-12 px-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transform transition-all duration-300">
          ...
          <h4 className="text-xl font-semibold text-gray-800">Massima Sicurezza</h4>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transform transition-all duration-300">
          ...
          <h4 className="text-xl font-semibold text-gray-800">Organizzazione Facile</h4>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transform transition-all duration-300">
          ...
          <h4 className="text-xl font-semibold text-gray-800">Accesso Facile</h4>
      ...
      <div className="mt-16 text-center">
        <Link to="/start" className="text-white bg-gradient-to-r from-green-500 to-teal-600 px-8 py-3 rounded-full shadow-lg hover:scale-105 transform transition-all duration-300">
          Inizia Ora
        </Link>
      </div>
    </div>
